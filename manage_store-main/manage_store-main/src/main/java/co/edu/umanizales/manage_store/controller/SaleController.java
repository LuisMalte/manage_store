...
public class SaleController {
    ...
    @GetMapping (path =  "/totalsotore/{code}")
    ...
    @GetMapping(path = "/storebyquantity/{quantity}")
    public ResponseEntity<ResponseDTO> getStoresByquantity(@PathVariable int quantity){
        return new ResponseEntity<>(new ResponseDTO(200,
                saleService.getStoresByquantity(storeService.getStores(), quantity,stores1 ), null),HttpStatus.OK);
    }
